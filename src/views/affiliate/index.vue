			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					>
						...
						<div class="ml-3 mt-3">
							AFFILIATE AGREEMENT w.e.f 6th June, 2018.
						</div>
						<div class="ml-3 mt-3">
							This agreement contains the complete terms and conditions that
							apply to an individual's or entity's participation in the
							linkcloudsurvey.com Affiliate Program (the "Program"). As used in
							this Agreement, "we" means linkcloudsurvey.com, and "you" means
							the applicant. "Site" means a World Wide Web site and, depending
							on the context, refers either to linkcloudsurvey.com located at
							the URL www.linkcloudsurvey.com, or to the site that you will link
							to our site (and which you will identify in your Program
							application).
						</div>
						...
						<div class="ml-3 mt-1">
							<p>
								...
								Program. Unsuitable sites include, but shall not be limited to,
								those that:
							</p>
							<div>Promote violence;</div>
							<div>Promote pornography and sexual content;</div>
							<div>
								Promote discrimination based on race, sex, religion,
								nationality, disability, sexual orientation, or age;
							</div>
							<div>Promote illegal activities;</div>
							<div>
								Attempt to copy and/or assume the creative or business identity
								of linkcloudsurvey.com in any manner;
							</div>
							<div>and/or, Otherwise violate intellectual property rights.</div>
							<div>
								Utilize parasite software Spam If we reject your application,
								you are welcome to reapply to the Program at any time. You
								should also note that if we accept your application and your
								site is thereafter determined (at our sole discretion) to be
								unsuitable for the Program, we may terminate this Agreement at
								any time.
							</div>
						</div>
						<div class="ml-3 mt-3" style="font-size: 14px; font-weight: 600">
						...
						<div class="ml-3 mt-1">
							...
							through our Affiliate Web Site. linkcloudsurvey.com will
							occasionally change the appearance and type of
							links/Banners/Creative made available to Affiliates.
							linkcloudsurvey.com may change the appearance of these links and
							may make changes to their appearance at any time without your
						...
						<div class="ml-3 mt-1">
							...
							be customers of linkcloudsurvey.com. Accordingly, all
							linkcloudsurvey.com rules, policies, and operating procedures
						...
						<div class="ml-3 mt-3">
							It is further the policy of linkcloudsurvey.com that marketing of
							...
							without linkcloudsurvey.com will not accept responsibility for any
							"SPAM" e-mails sent by an affiliate pertaining to
							linkcloudsurvey.com. SPAM, for the purposes of this agreement is
						...
						<div class="ml-3 mt-3">
							The technical operation of your site and all related equipment The
						...
						<div class="ml-3 mt-1">
							...
							site, all links to our site, and all linkcloudsurvey.com
							...
							referral fees on our sales of linkcloudsurvey.com products
							occurring during the term, and referral fees earned through the
						...
						<div class="ml-3 mt-1">
							You agree to release, indemnify and hold gentingconsulting.com,
							its contractors, agents, employees, officers, directors and
							affiliates harmless from any and all liabilities, claims and
							expenses including legal fees, of third parties relating to or
							rising under this Agreement and of the use of images, including
							without limitation infringement by you or someone else (such as
							your website host) of any intellectual property or other
							proprietary right of any person or entity, or from the violation
							of any of gentingconsulting.com operating rule or policy relating
							to the use of the images provided. When gentingconsulting.com is
							threatened with suit by a third party, gentingconsulting.com may
							seek written assurances from you concerning your promise to
							indemnify gentingconsulting.com; your failure to provide that
							assurance may be considered by gentingconsulting.com to be a
							breach of your Agreement and subject to termination by
						...
						>
							...
							contact us at linkcloudsurvey Support. We will respond
							promptly.
						</div>
					</div>
				</div>
