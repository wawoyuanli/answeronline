  ...
  <div class="register-wrap">
    ...
    <div class="container" style="margin-top: 10rem">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <label for="userName" class="mt-2 text-left" style="width: 540px"
            >Username
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <label for="email" class="text-left mt-2" style="width: 255px"
            >Email
            <label style="color: red">*</label>
          </label>
          <input
      ...
      <div class="row">
        <div class="col-lg-3"></div>
        <div class="col-lg-6">
          <label for="remark" class="text-left mt-2" style="width: 540px"
      ...
      <div class="row">
        <div class="col-lg-3"></div>
        <div class="col-lg-6">
          <label for="password" class="text-left mt-2" style="width: 540px"
            >Password
            <label style="color: red">*</label>
          </label>
          <input
      ...
      <div class="row">
        <div class="col-lg-3"></div>
        <div class="col-lg-3">
          <label for="firstName" class="text-left mt-2" style="width: 255px"
            >FirstName
            <label style="color: red">*</label>
          </label>
          <input
        ...
        <div class="col-lg-3">
          <label for="lastName" class="text-left mt-2" style="width: 255px"
            >LastName
            <label style="color: red">*</label>
          </label>
          <input
      ...
      <div class="row">
        <div class="col-lg-3"></div>
        <div class="col-lg-3">
          <label for="sex" class="text-left mt-2" style="width: 540px"
            >Sex
            <label style="color: red">*</label>
          </label>
      ...
      <div class="row">
        <div class="col-lg-3"></div>
        <div class="col-lg-6">
          <label for="referrer" class="text-left mt-2" style="width: 540px"
            >Address ：
          </label>
          <input
        ...
        <div class="col-lg-6">
          <div style="display: flex; padding: 4px 0px; align-items: center">
            ...
            <div style="display: flex; margin-left: 5px">
              ...
              <a style="color: #ff6f00" href="#/terms" class="ml-2 text-decoration-none"
          ...
          <div style="display: flex; padding: 4px 0px; align-items: center">
            ...
            <div style="display: flex; margin-left: 5px">
              <div>I have read and accepted</div>
              <a style="color: #ff6f00" href="#/privacyPolicy" class="ml-2 text-decoration-none"
                >Privacy Policy *</a
              >
            </div>
          </div>
